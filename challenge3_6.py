...
def modifier():
    ...
    produit = input("enter le nom de produit que vous modifier: ")
    if produit in mes_liste['inventaire']:
        index = mes_liste['inventaire'].index(produit)
        mes_liste['produit'][index] = input("entre le nouveau produit: ")
        mes_liste['quantite'][index] = input("enter le nouveau quantite: ")
...
def aficher():
    print("\n******** Inventaire **********\n\n")
    for i in range(len(mes_liste['inventaire'])):
        print(f"type: {mes_liste['inventaire'][i]}, produit: {mes_liste['produit'][i]}, Quantité: {mes_liste['quantite'][i]}")
    print("\n\n*******************************")
